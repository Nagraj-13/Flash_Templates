                    ...
                    <div className="container relative z-[3] px-4 text-center">
                        ...
                        >
                            ...
                            <p className="mx-auto max-w-3xl text-gray-400 sm:text-xl leading-relaxed">
                                At a flash, you're all set with a preconfigured boilerplate of Vite
                                + React, Tailwind CSS, Redux, ShadCN UI, and React Router Dom —
                                supported for both JavaScript and TypeScript. Just{" "}
